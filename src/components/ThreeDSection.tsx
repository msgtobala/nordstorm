...
const ThreeDSection: React.FC = () => {
  ...
  return (
    <section className="py-8 md:py-12 lg:py-16 xl:py-20 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 4k:px-container-x">
      <div className="max-w-container mx-auto"
          ...
          <div className="relative max-w-lg w-full">
            <div className="aspect-square flex items-center justify-center p-8 md:p-12">
              <img
                ...
                alt={`Alpha 3 in ${selectedColorOption.name}`}
        ...
        {/* Track Image - Centered and Bigger, Closer to bag */}
